...
setState(() {
  if(buttonText=="C"){
    equation="0";
    result="0";
    equationFrontSize=38.0;
    resultFontSize=48.0;
  }

  else if(buttonText == "⌫"){
    equationFrontSize=48.0;
    resultFontSize=38.0;
      ...
      body: Column(
        children: <Widget>[
          Container(
            ...
            child: Text(equation,style: TextStyle(fontSize: equationFrontSize),maxLines: 2,overflow: TextOverflow.ellipsis,),
          ),
          Container(
            alignment: Alignment.centerRight,
            padding: EdgeInsets.fromLTRB(10, 20, 10, 0),
            child: Text(result,style: TextStyle(fontSize: equationFrontSize),maxLines: 2,overflow: TextOverflow.ellipsis,),
          ),
